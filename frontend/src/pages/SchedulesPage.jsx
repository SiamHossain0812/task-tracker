                ...
                <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto">
                    ...
                    <div className="flex bg-gray-100/80 p-1 rounded-2xl border border-gray-200 shadow-inner">
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 flex items-center gap-2 ${viewMode === 'list'
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 flex items-center gap-2 ${viewMode === 'calendar'
                                ? 'bg-white text-emerald-600 shadow-md transform scale-105'
                                : 'text-gray-500 hover:text-gray-700'
                            }`}
                        >
                    ...
                    {/* Filter Toggle (Only show in list mode) */}
                    {viewMode === 'list' && (
                        <div className="flex bg-gray-100/80 p-1 rounded-2xl border border-gray-200 shadow-inner">
                            {[
